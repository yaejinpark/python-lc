...
def part1():
    ...
    for line in lines:
        strng = "".join(line.split())
        if strng in all_cases['win']:
            my_score += 6
        elif strng in all_cases['draw']:
            my_score += 3
...
def part2():
    ...
    for line in lines:
        strng = "".join(line.split())
        computer_move = strng[0]
        if strng[1] == 'X':
            my_index = rps.index(computer_move) - 1
        elif strng[1] == 'Y':
            my_index = rps.index(computer_move)
        else:
            my_index = rps.index(computer_move) + 1
        my_score += my_index %len(rps) + 1
        my_score += all_cases[strng[1]]

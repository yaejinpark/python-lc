...
# He says that it has many fancy features, but the most important one to set 
# up right now is the communication system.

# However, because he's heard you have significant experience dealing with signal-
# based systems, he convinced the other Elves that it would be okay to give you their 
...
#     p = 0
#     while p < len(str_list) - 4:

#         bracket = str_list[p:p+4]
#         print(p+1, bracket, set(bracket))
#         if len(set(bracket)) == len(bracket):
#             break
#         else:
#             counter +=1
#             p += 1

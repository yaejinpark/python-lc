...
#     ranges = re.split(',|\-', i.rstrip())
#     zones_1 = [i for i in range(int(ranges[0]), int(ranges[1])+1)]
#     zones_2 = [i for i in range(int(ranges[2]), int(ranges[3])+1)]

#     check1 = all(item in zones_1 for item in zones_2)
#     check2 = all(item in zones_2 for item in zones_1)
...
for i in file.readlines():
    ...
    overlap1 = [i for i in zones_1 if i in zones_2]
    overlap2 = [i for i in zones_2 if i in zones_1]

...
# the ferry dock. "Boat races! Open to the public! Grand prize is an all-expenses-paid 
# trip to Desert Island!" That must be where the sand comes from! 
...
# The organizer explains that it's not really a traditional race - instead, you will get a 
# fixed amount of time during which your boat has to travel as far as it can, and you win if your boat goes the farthest.
...
# THE INPUT IS SHORT, HERE'S THE WHOLE THING:
# Time:        51     92     68     90
# Distance:   222   2031   1126   1225


# time_distance = [(51, 222),(92,2031),(68,1126),(90,1225)]
# res = []

# for cell in time_distance:
...
# --- Part Two ---
# As the race is about to start, you realize the piece of 
# paper with race times and record distances you got earlier 
# actually just has very bad kerning. There's really only one race - 
...
# Time:      71530
# Distance:  940200
# Now, you have to figure out how many ways there are to win 
# this single race. In this example, the race lasts for 71530 milliseconds 
...
time_distance = [(51926890, 222203111261225)]
res = []
